	...
	<div class="wrapper-container">
	  ...
	  <div class="site wrapper-content">
	    <div class="home-content" role="main">
	      ...
	      <div class="padding-top-6x padding-bottom-6x section-background" v-bind:style="{'background-image':'url(images/home/bg-popular.jpg)'}">
	        <div class="container">
	                  ...
	                  <div class="item_content">
	                    <div class="post_images">
	                      ...
	                      <span class="price"><del>
	                        ...
	                        <img src="./../images/tour/430x305/tour-2.jpg">
	                      </a>
	      ...
	      <div class="padding-top-6x padding-bottom-6x bg__shadow section-background" v-bind:style="{ 'background-image':'url(./images/home/bg-pallarax.jpg)'}">
	        <div class="container">
	          <div class="shortcode_title text-white title-center title-decoration-bottom-center">
	      ...
	      <div class="bg__shadow padding-top-6x padding-bottom-6x section-background" v-bind:style="{'background-image':'url(images/home/bg-pallarax.jpg)'}">
	        <div class="container">
	          <div class="row">
	            <div class="col-sm-2"></div>
	            <div class="col-sm-8">
	              <div class="discounts-tour">
	                <h3 class="discounts-title white-text"> Special Tour in April, Discover Australia for 100 customers with
	                  <span> discount 50%</span></h3>
	                <span class="line white-text"></span>
	  ...
	  <div class="wrapper-subscribe" v-bind:style="{'background-image': 'url(images/home/bg_newletter.jpg)'}">
