...
<div class="wrapper-container">
	...
	<div class="site wrapper-content">
		<div class="home-content" role="main">
			...
			<div class="padding-top-6x padding-bottom-6x section-background" style="background-image:url(./../assets/images/home/bg-popular.jpg)">
				<div class="container">
					<div class="shortcode_title title-center title-decoration-bottom-center">
						<div class="title_subtitle">Take a look our</div>
						<h3 class="title_primary">MOST RECOMMENDED TOURS</h3><span class="line_after_title"></span>
					</div>
