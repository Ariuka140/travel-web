...
(function () {
	...
	if (b = document.getElementById("site-navigation"))
		if (d = b.getElementsByTagName("button")[0], "undefined" !== typeof d)
			if (a = b.getElementsByTagName("ul")[0], "undefined" === typeof a) d.style.display = "none";
			else {
				a.setAttribute("aria-expanded", "false"); - 1 === a.className.indexOf("nav-menu") && (a.className += " nav-menu");
				d.onclick = function () {
					-1 !== b.className.indexOf("toggled") ? (b.className = b.className.replace(" toggled", ""), d.setAttribute("aria-expanded", "false"), a.setAttribute("aria-expanded", "false")) : (b.className += " toggled", d.setAttribute("aria-expanded", "true"), a.setAttribute("aria-expanded", "true"))
				};
				e = a.getElementsByTagName("a");
				f = a.getElementsByTagName("ul");
				for (var c = 0, g = f.length; c < g; c++) f[c].parentNode.setAttribute("aria-haspopup", "true");
				c = 0;
				for (g = e.length; c < g; c++) e[c].addEventListener("focus", h, !0), e[c].addEventListener("blur", h, !0)
			}
})();
...
(function (a) {
			...
			a(this).each(function () {
				function g(c) {
					...
					"left" === b.edge ? (a(".drag-target").css({
						...
						easing: "easeOutCubic",
						complete: function () {
							!0 === c && (d.removeAttr("style"), d.css("width", b.menuWidth))
						}
					})) : (a(".drag-target").css({
						width: "",
						right: "0",
				...
				"left" == b.edge ? (d.css("left", -1 * (b.menuWidth + 10)), a(".drag-target").css({
					left: 0
				})) : (d.addClass("right-aligned").css("right", -1 * (b.menuWidth + 10)).css("left", ""), a(".drag-target").css({
					right: 0
				}));
				d.hasClass("fixed") && 992 < window.innerWidth && d.css("left", 0);
				d.hasClass("fixed") && a(window).resize(function () {
					992 < window.innerWidth ? 0 !== a("#sidenav-overlay").css("opacity") && e ? g(!0) : (d.removeAttr("style"), d.css("width", b.menuWidth)) : !1 === e && ("left" === b.edge ? d.css("left", -1 * (b.menuWidth + 10)) : d.css("right", -1 * (b.menuWidth + 10)))
				});
				if (!0 === b.closeOnClick) d.on("click.itemclick", "a:not(.collapsible-header)", function () {
					g()
				});
				var e = !1;
				...
				a(".drag-target").hammer({
					...
					if ("touch" == c.gesture.pointerType) {
						...
						"left" === b.edge ? (c < b.menuWidth / 2 ? e = !1 : c >= b.menuWidth / 2 && (e = !0), d.css("left", c - b.menuWidth)) : (c < window.innerWidth - b.menuWidth / 2 ? e = !0 : c >= window.innerWidth - b.menuWidth / 2 && (e = !1), f = -1 * (c - b.menuWidth / 2), 0 < f && (f = 0), d.css("right", f));
					...
					if ("touch" == c.gesture.pointerType)
						if (c = c.gesture.velocityX, "left" === b.edge)
							if (e && .3 >= c || -.5 > c) d.velocity({
								left: 0
							}, {
								duration: 300,
								queue: !1,
								...
								if (!e || .3 < c) a("body").css("overflow", ""), d.velocity({
									left: -1 * (b.menuWidth + 10)
								}, {
									duration: 200,
									queue: !1,
					...
					else if (!e || -.3 > c) a("body").css("overflow", ""), d.velocity({
						right: -1 * (b.menuWidth + 10)
					}, {
						duration: 200,
						queue: !1,
	...
	a.fn.sideNav = function (b) {
		...
		if ("object" !== typeof b && b) a.error("Method " + b + " does not exist on jQuery.sideNav");
